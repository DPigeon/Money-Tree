...
public final class AlpacaOrderStatus {
    ...
    */
   public static String DONE_FOR_DAY = "done_for_day";
   /**
    ...
    */
   public static String PENDING_REPLACE = "pending_replace";
